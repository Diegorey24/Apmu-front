...
export const cambiarTitularHijo = (id, idAfiliado) => client.patch(`/hijos/${id}/titular`, { idAfiliado });
export const getHijosByAfiliado = (idAfiliado) => client.get(`/hijos/${idAfiliado}`);